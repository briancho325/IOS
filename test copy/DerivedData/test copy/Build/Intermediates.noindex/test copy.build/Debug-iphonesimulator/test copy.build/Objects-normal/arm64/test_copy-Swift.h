...
#ifndef TEST_COPY_SWIFT_H
#define TEST_COPY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="test_copy",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9test_copy11AppDelegate")
...
SWIFT_CLASS("_TtC9test_copy18CityViewController")
...
@interface CityViewController (SWIFT_EXTENSION(test_copy))
- (void)viewDidLoad;
@end


@interface CityViewController (SWIFT_EXTENSION(test_copy)) <UIPickerViewDelegate>
- (NSString * _Nullable)pickerView:(UIPickerView * _Nonnull)pickerView titleForRow:(NSInteger)row forComponent:(NSInteger)component SWIFT_WARN_UNUSED_RESULT;
@end


@interface CityViewController (SWIFT_EXTENSION(test_copy)) <UIPickerViewDataSource>
...
SWIFT_CLASS("_TtC9test_copy17MapViewController")
...
@interface MapViewController (SWIFT_EXTENSION(test_copy))
...
SWIFT_CLASS("_TtC9test_copy13SceneDelegate")
